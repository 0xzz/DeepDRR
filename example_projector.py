...
def generate_projections_on_sphere(volume_path, save_path, min_theta, max_theta, min_phi, max_phi, spacing_theta,
                                   spacing_phi, photon_count, camera, spectrum, scatter=False, origin=[0, 0, 0]):
    # generate angle pairs on a sphere
    thetas, phis = projection_matrix.generate_uniform_angles(min_theta, max_theta, min_phi, max_phi, spacing_theta,
                                                             spacing_phi)
    ...
    forward_projections = projector.generate_projections(proj_mats, volume, materials, origin, voxel_size,
...
def main():
    #2x2 binning
    camera = Camera(sensor_width=1240, sensor_height=960, pixel_size=0.31, source_to_detector_distance=1200,
    ...
    generate_projections_on_sphere(dicompath, save_path, min_theta, max_theta, min_phi, max_phi, spacing_theta,
